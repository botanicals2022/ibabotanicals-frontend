          ...
          <Grid item container sx={{ gap: "10px" }} xs direction="row">
            ...
            <Grid item xs>
              <Typography
                ...
                display="block"
              >
                : {theElemiContext.selected?.material}
              </Typography>
            </Grid>
          </Grid>
          ...
          <Grid item container sx={{ gap: "10px" }} xs direction="row">
            ...
            <Grid item xs>
              <Typography
                ...
                display="block"
              >
                : {theElemiContext.selected?.oilInvId}
              </Typography>
            </Grid>
          </Grid>
          ...
          <Grid item container sx={{ gap: "10px" }} xs direction="row">
            ...
            <Grid item xs>
              <Typography
                ...
                display="block"
              >
                : {theElemiContext.selected?.fuelInvId}
              </Typography>
            </Grid>
          </Grid>
          ...
          <Grid item container sx={{ gap: "10px" }} xs direction="row">
            ...
            <Grid item xs>
              <Typography
                ...
                display="block"
              >
                : {BrowserStorage.FoundUser(theElemiContext.selected?.userId)}
                {/* {theElemiContext.selected?.userId} */}
              </Typography>
            </Grid>
          </Grid>
          ...
          <Grid item container sx={{ gap: "10px" }} xs direction="row">
            ...
            <Grid item xs>
              <Typography
                ...
                display="block"
              >
                : {TimeStamp(theElemiContext.selected?.createdAt)}
              </Typography>
            </Grid>
          </Grid>
          ...
          <Grid item container sx={{ gap: "10px" }} xs direction="row">
            ...
            <Grid item xs>
              <Typography
                ...
                display="block"
              >
                : {TimeStamp(theElemiContext.selected?.updatedAt)}
              </Typography>
            </Grid>
          </Grid>
        </Grid>
