...
const DataTbl = (props) => {
  ...
  const handleViewRecord = (event, data) => {
    Swal.fire({
      title: `View Record`,
                ...
                .map((row, RowIndx) => {
                  return (
                    <TableRow
                      hover
                      sx={{
                        backgroundColor: RowIndx % 2 === 0 ? "#fff" : "#ececec",
                        border: "2px solid #e2e8f0",
                        borderCollapse: "collapse",
                      }}
                      tabIndex={-1}
                    ...
                    >
                      <TableCell
                        onClick={(e) => handleViewRecord(e, row)}
                        sx={{
                          cursor: "pointer",
                          border: "2px solid #e2e8f0",
                          borderCollapse: "collapse",
                      ...
                      <TableCell
                        ...
                        align="center"
                      >
                        {row.raw_materials_delivery_date}
                      </TableCell>
                      ...
                      <TableCell
                        ...
                        align="center"
                      >
                        {row.resin_input_material_weight}
                      </TableCell>
                      ...
                      <TableCell
                        ...
                        align="center"
                      >
                        {row.total_oil_yield_recovery_less}
                      </TableCell>
