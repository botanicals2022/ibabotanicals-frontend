...
const CreateGeneralInventory = (props) => {
  const formTitle = "Create New General Inventory";
  const { open } = props;
  ...
  const handleOnSubmit = (e) => {
    console.log(obj);
    theGeneralInventoryContext.createGeneralInventory(obj);
  };
...
export default CreateGeneralInventory;
