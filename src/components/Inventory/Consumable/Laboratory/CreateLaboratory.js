...
const CreateLaboratory = (props) => {
  const formTitle = "Create New Laboratory Consumable";
  const { open } = props;
  ...
  const handleOnSubmit = (e) => {
    console.log(obj);
    if (addPurchaseItem) {
      theLaboratoryContext.createLaboratoryPurchaseItem(obj);
    } else {
      theLaboratoryContext.createLaboratory(obj);
    }
  };
